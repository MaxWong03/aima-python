...
#Return the number of people in the team with  largest number of people
def countMaxTeam(csp_sol):
	team = {}
	maxTeam = 0
...
#Count the number of teams people are divided into
...
#list of colors, using number to represent 30 different colours 

"""
d = # of values in the domain
n = all possible colors
	...
	for z in range(30):
		if stop0 == False:
			...
			if csp_sol0 != None:
				...
				print("Ice Breaker Problem for n = 30, p = 0.1")
	...
	for z in range(30):
		if stop1 == False:
			...
			if csp_sol1 != None:
				...
				print("Ice Breaker Problem for n = 30, p = 0.2")
	...
	for z in range(30):
		if stop2 == False:
			...
			if csp_sol2 != None:
				...
				print("Ice Breaker Problem for n = 30, p = 0.3")
	...
	for z in range(30):
		if stop3 == False:
			...
			if csp_sol3 != None:
				...
				print("Ice Breaker Problem for n = 30, p = 0.4")
	...
	for z in range(30):
		if stop4 == False:
			...
			if csp_sol4 != None:
				...
				print("Ice Breaker Problem for n = 30, p = 0.5")
